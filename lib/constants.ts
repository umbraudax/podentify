...
export const APP_NAME = 'Podentify';
...
export const SUPPORTED_MEDIA_FORMATS = [...SUPPORTED_AUDIO_FORMATS, ...SUPPORTED_VIDEO_FORMATS];
...
// URLs and endpoints
export const SUPPORT_EMAIL = 'hello@podentify.com';
