          ...
          <div className="mt-24 max-w-3xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We support all major audio formats including MP3, WAV, M4A, and more. Files can be up to 500MB in size.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  How accurate are the AI-generated show notes?
                </h3>
                <p className="text-gray-600">
                  Our AI achieves 95%+ accuracy in transcription and intelligently structures content into readable show notes. You can always edit and customize the output.
                </p>
              </div>
            </div>
          </div>
